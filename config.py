...
BOT_TOKEN = getenv("BOT_TOKEN", "5512152287:AAHweHjBQr-KNA88Th959DpIqMcjyo6WQwQ")
...
ALIVE_NAME = getenv("ALIVE_NAME", "Ali Qassim")
BOT_USERNAME = getenv("BOT_USERNAME", "SPOT_MUBOT")
OWNER_ID = getenv("OWNER_ID", "1759927346")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1759927346").split()))
